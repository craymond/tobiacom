...
public class SG_MiseEnForme extends MiseEnForme {
    
    /**
     * 
     * @param releves 
     */
    public SG_MiseEnForme() {
	super();
    }
	...
	try {
	    ...
	    System.out.println("Exception MEF: " + e.getMessage());
	}
    }
	...
	String compte    = "COMPTE: (" + MEF_Outils.marqueAntoine(aReleve.getNumCompte());
	...
	String ancienFRF  = MEF_Outils.montant(ae.getMontantAncienSoldeFRF(), ae.getDateAncienSolde());
	...
	String nouveauFRF  = MEF_Outils.montant(ae.getMontantNouveauSoldeFRF(), ae.getDateNouveauSolde());
